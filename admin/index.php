           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li><a href="index.php?halaman=pelanggan"><i class="fa fa-user"></i> Clients</a></li>
                    <li><a href="index.php?halaman=managestaff"><i class="fa fa-user"></i> Staff</a></li>
                    <li><a href="index.php?halaman=manageadmin"><i class="fa fa-user"></i> Admin</a></li>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                if(isset($_GET['halaman']))
                {
                    ...
                    else if($_GET['halaman']=="managestaff")
                    {
                        include 'managestaff.php';
                    }
                    else if($_GET['halaman']=="manageadmin")
                    {
                        include 'manageadmin.php';
                    }
                    else if($_GET['halaman']=="addstaff")
                    {
                        include 'addstaff.php';
                    }
                    else if($_GET['halaman']=="ubahstaff")
                    {
                        include 'ubahstaff.php';
                    }
                    else if($_GET['halaman']=="hapusstaff")
                    {
                    ...
                    else if($_GET['halaman']=="addadmin")
                    {
                        include 'addadmin.php';
                    }
                    else if($_GET['halaman']=="changepassadm")
                    {
                        include 'changepassadm.php';
                    }
                }
                else
                {
